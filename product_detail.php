...
$review_query = "SELECT reviews.rating, reviews.review_text, reviews.created_at, users.username, users.profile_pic 
                 FROM reviews 
...
$stmt = mysqli_prepare($conn, $product_query);
if (!$stmt) {
    die("Database error: " . mysqli_error($conn));  // Debugging line
}
